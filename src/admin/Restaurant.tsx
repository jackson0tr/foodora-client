...
const Restaurant = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto my-10">
      <div>
        <div>
          <h1 className="font-extrabold text-2xl mb-5">{t("Add Restaurants")}</h1>
            ...
            <div className="md:grid grid-cols-2 gap-6 space-y-2 md:space-y-0">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={changeEventHandler}
                  placeholder={t("Enter your delivery time")}
                />
                {errors && (
                  <span className="text-xs text-red-600 font-medium">
                    {errors.deliveryTime}
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder={t("Enter your cuisines")}
                />
                {errors && (
                  <span className="text-xs text-red-600 font-medium">
                    {errors.cuisines}
              ...
              <div>
                <Label>{t("Upload Restaurant Banner")}</Label>
                <Input
                  onChange={(e) =>
                    setInput({
                      ...input,
